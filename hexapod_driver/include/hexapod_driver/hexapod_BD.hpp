#ifndef HEXAPOD_DRIVER_HEXAPOD_BD_HPP
#define HEXAPOD_DRIVER_HEXAPOD_BD_HPP
...
namespace hexapod_ros {
    ...
    class HexapodBlackDrops {
    public:
        using trajectory_client = actionlib::SimpleActionClient<control_msgs::FollowJointTrajectoryAction>;

        HexapodBlackDrops(ros::NodeHandle nh, std::string ns = "/dynamixel_controllers");
        ~HexapodBlackDrops();
