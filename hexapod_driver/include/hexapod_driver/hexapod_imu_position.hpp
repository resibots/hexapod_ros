#ifndef HEXAPOD_DRIVER_HEXAPOD_IMU_POISTION_HPP
#define HEXAPOD_DRIVER_HEXAPOD_IMU_POISTION_HPP
...
namespace hexapod_ros {
    ...
    public:
        ...
        HexapodIMUPos(ros::NodeHandle nh, std::string ns = "/dynamixel_controllers");
        ~HexapodIMUPos();
